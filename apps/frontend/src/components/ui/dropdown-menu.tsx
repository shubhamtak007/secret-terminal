...
function DropdownMenuItem({
    ...
    return (
        <DropdownMenuPrimitive.Item
            ...
            className={cn(
                `relative flex cursor-pointer items-center gap-2 rounded-sm p-[4px_6px] text-[13px] outline-hidden
                 ...
                 dark:focus:bg-[var(--row-hover-color)] dark:data-[variant=destructive]:focus:bg-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0
...
function DropdownMenuSubContent({
    ...
    return (
        <DropdownMenuPrimitive.SubContent
            ...
            className={cn(
                `z-50 min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md
