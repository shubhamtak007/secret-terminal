...
function Textarea({ className, ...props }: React.ComponentProps<"textarea">) {
    return (
        <textarea
            data-slot="textarea"
            className={cn(
                `border-input placeholder:text-muted-foreground focus-visible:border-[var(--main-color)]
                 focus-visible:outline-solid focus-visible:outline-1 focus-visible:outline-[var(--main-color)]
